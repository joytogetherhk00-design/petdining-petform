  ...
  try {
    ...
    if (action === 'approve') {
      ...
      const whatsappMsg = encodeURIComponent(
        ...
        `帳戶編號：${customerId}\n` +
        `計劃：${selectedPlan.name}\n` +
        `Credits：${selectedPlan.credits.toLocaleString()}\n\n` +
        `請即登入：https://www.petdining.biz\n\n` +
        `如有問題，請 WhatsApp 我們：9867 3497`
      );
          ...
          <div style="font-family:sans-serif;max-width:600px;margin:auto;color:#1f2937;">
            ...
            <div style="background:#fff;padding:24px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px;">
              ...
              <div style="background:#f9fafb;padding:16px;border-radius:8px;margin:16px 0;">
                ...
                <p style="margin:4px 0;"><strong>每月 Credits：</strong>${selectedPlan.credits.toLocaleString()}</p>
              </div>
              <p>請即登入開始使用：</p>
        ...
        body: `
          <div style="font-family:sans-serif;max-width:600px;margin:auto;color:#1f2937;">
            ...
            <div style="background:#fff;padding:24px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px;">
              ...
              <p>如有疑問或希望重新申請，請聯絡我們：</p>
              <p>WhatsApp：<a href="https://wa.me/85298673497">9867 3497</a></p>
              <p>Email：info@petdininghk.com</p>
            </div>
          </div>
        `,
        from_name: 'PetDining PetForm',
